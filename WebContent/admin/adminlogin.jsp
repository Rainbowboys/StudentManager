			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="icon-leaf green"></i> <span class="red">Admin</span>
								<span class="white">Manager</span>
							</h1>
							<h4 class="blue">&copy; 管理员登录</h4>
						</div>
							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form role="form"
											action="${pageContext.request.contextPath}/admin/AdminServlet?method=login"
											method="post" id="myform">
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" name="account"
														placeholder="Username"  id="account"/> <i class="icon-phone"></i>
												</span>
