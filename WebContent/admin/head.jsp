...
<div class="container-fluid">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="#">学生综合管理平台</a>
	</div>
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<ul class="nav navbar-nav navbar-right">
				...
				<li><a target="_parent" href="${pageContext.request.contextPath}/admin/UserDetail">用户名：${sessionScope.adminbean.telphone}</a></li>
