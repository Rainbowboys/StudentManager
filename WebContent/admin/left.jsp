		...
		<div class="menu">
			<div class="menuParent">
				...
				<div class="menuList">
					...
					<div>
						<a href="${pageContext.request.contextPath}/admin/AdminServlet?method=tolist" target="mainAction">查看管理员信息</a>
					</div>
				</div>
			</div>
			<div class="menuParent">
				...
				<div class="menuList">
					<div>
						<a href="${pageContext.request.contextPath }/static/teacher/addUser.jsp"
							target="mainAction">添加教师</a>
					</div>
					<div>
						<a href="${pageContext.request.contextPath }/teacher/TeacherServlet?method=tolist"
							target="mainAction">查看教师</a>
					</div>
				</div>
			</div>
			<div class="menuParent">
				...
				<div class="menuList">
					<div>
						<a href="${pageContext.request.contextPath }/static/front/user/addUser.jsp"
							target="mainAction">添加学生</a>
					</div>
					<div>
						<a href="${pageContext.request.contextPath }/student/StudentServlet?method=tolist"
							target="mainAction">查看学生</a>
					</div>
				</div>
			</div>
			<div class="menuParent">
