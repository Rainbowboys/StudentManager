...
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/assets/css/ui.jqgrid.css" />
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="alert alert-info">
								<i class="icon-hand-right"></i> Please note that demo server is not configured to save the changes, therefore you may get an
								error message.
...
<![endif]-->
	...
	<script src="${pageContext.request.contextPath}/static/assets/js/jqGrid/jquery.jqGrid.min.js"></script>
	<script src="${pageContext.request.contextPath}/static/assets/js/jqGrid/i18n/grid.locale-en.js"></script>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/Jqgridteacher.js"></script>
