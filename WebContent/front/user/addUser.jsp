	...
	<div class="row-fluid" style="margin-top: 200px;">
		...
		<div class="col-md-6">
			<form role="form" class="form-horizontal"
				action="${pageContext.request.contextPath}/student/StudentServlet?method=regStudent&updateId=${updatebean.id}" method="post"
				id="checkForm">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input class="form-control" name="account" type="text"
							...
							value="${updatebean.tel}" />
							<span id="accountalert"
							style="color:red;	font-size: 12px;"></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label" for="account">学生名字</label>
					<div class="col-md-9">
						<input class="form-control" name="studentname" type="text"
							id="studentname" placeholder="姓名"
