jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		editurl : $path_base + "/teacher/TeacherServlet",// nothing is saved
		caption : "教师信息操作",
		autowidth : true
	...
	// 自定义表单验证
	function telcheck(value, telphone) {
