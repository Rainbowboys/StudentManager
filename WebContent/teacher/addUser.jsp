	...
	<div class="row-fluid" style="margin-top: 200px;">
		...
		<div class="col-md-6">
			<form role="form" class="form-horizontal"
				action="${pageContext.request.contextPath}/teacher/TeacherServlet?method=regTeacher&updateId=${updatebean.id}" method="post"
				id="checkForm">
				<div class="form-group">
					<label class="col-md-3 control-label" for="account">手机号</label>
					<div class="col-md-9">
						<input class="form-control" name="account" type="text"
							id="account" placeholder="手机号码"
							value="${updatebean.telphone}" />
							<span id="accountalert"
							style="color:red;	font-size: 12px;"></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label" for="account">老师名字</label>
					<div class="col-md-9">
						<input class="form-control" name="teachername" type="text"
							id="teachername" placeholder="姓名"
							value="${updatebean.name}" />
					</div>
				</div>
				<div class="form-group">
